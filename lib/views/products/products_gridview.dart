...
class ProductsGridview extends StatefulWidget {
  ...
  const ProductsGridview({super.key, this.categoryId, this.categoryname, this.isfromcatogory});
...
class _ProductsGridviewState extends State<ProductsGridview> {
  ...
  return ChangeNotifierProvider(
    create: (context) => ReviewProvider()..fetchReviews(product.id), // Fetch reviews on creation
          ...
          child: InkWell(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PremiumProductDetailPage(id: product.id),
                ),
              );
            },
            child: Column(
                  ...
                  children: [
                    AspectRatio(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          product.pImage.first.replaceAll("httplocalhost:5000/uploads/", ""),
                          fit: BoxFit.cover,
